...
module V2::Logic
  module Secrets
    class BaseSecretAction < V2::Logic::Base
      ...
      # NOTE: Onetime::FlexibleHashAccess was recently removed and relegated
      # to be V1::FlexibleHashAccess. Making a note in case weird behaviour
      # pops up. -- delano (2025-06-28)
      ...
      def save_secret
        secret.encrypt_value(secret_value, size: 1_000_000) # 1MB
        metadata.ttl             = ttl*2
        secret.ttl               = ttl
