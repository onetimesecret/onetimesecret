...
module DomainsAPI
  module Logic
    class Base < V2::Logic::Base
      # Domains API-specific serialization helper
      #
      ...
      # Override safe_dump to use JSON types in Domains API
      #
      # This allows Domains logic classes to inherit from v2 but get JSON serialization
