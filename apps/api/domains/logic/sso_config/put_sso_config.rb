# apps/api/domains/logic/sso_config/put_sso_config.rb
#
...
module DomainsAPI
  module Logic
    module SsoConfig
      # PUT Domain SSO Configuration (full replacement)
      #
      # @api Creates or replaces the SSO configuration for a custom domain.
