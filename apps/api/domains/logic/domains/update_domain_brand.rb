  ...
  module Domains
    ...
    class UpdateDomainBrand < DomainsAPI::Logic::Base
      ...
      def process_params
        ...
        # Exclude allow_public_homepage — managed via /homepage-config endpoint.
        valid_keys = Onetime::CustomDomain::BrandSettings.members.map(&:to_s) - %w[allow_public_homepage]
