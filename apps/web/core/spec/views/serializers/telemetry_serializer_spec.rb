...
RSpec.describe Core::Views::TelemetrySerializer do
  ...
  # produce a federated, cross-region-correlatable identity in the payload.
  ...
  # A residency read that blows up must cost this render its identity, not hand
  # it a DIFFERENT one — a second ref for the same human forks one Sentry actor
