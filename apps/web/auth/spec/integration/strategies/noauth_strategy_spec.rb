# apps/web/auth/spec/integration/strategies/noauth_strategy_spec.rb
#
...
#
# Run:
#   pnpm run test:rspec apps/web/auth/spec/integration/strategies/noauth_strategy_spec.rb
