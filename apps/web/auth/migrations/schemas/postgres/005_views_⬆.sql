...
COMMENT ON VIEW accounts_with_status IS 'Account summary with status and basic security flags';
...
COMMENT ON VIEW active_sessions_with_accounts IS 'Active sessions with account details and expiration status';
