...
**Schema Version:** 1.0
**Last Updated:** 2026-05-27 19:34 UTC
...
> Legacy plans no longer in the active catalog are documented separately
> in `legacy-plans.md` so that file is not overwritten by regeneration.
...
- **`extended_default_expiration`**: Extended secret expiration (30 days default)
...
|---------|------|------|---------|--------|---------------|---------------|--------|
| free_v1 | Free | free | multi |  | 0 | ✓ |  |
| identity_plus_v1 | Identity Plus () | single_account | multi |  | 10 | ✓ |  |
...
{
  "app": "onetimesecret",
  "plan_id": "Unique plan identifier (must match catalog key)",
...
```json
{
  ...
  "limit_members_per_team": "Aggregate member cap across all roles (-1 for unlimited)",
  "limit_owners_per_team": "Max owners per organization (typically 1)",
  "limit_admins_per_team": "Max admin members (-1 for unlimited)",
  "limit_regular_members_per_team": "Max regular members (-1 for unlimited)",
