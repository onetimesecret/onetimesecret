# apps/web/billing/workers/billing_worker.rb
#
# frozen_string_literal: true

require 'stripe'

# Core job infrastructure - use require_relative with path from Onetime::HOME
# since this file lives outside lib/ directory
require_relative '../../../../lib/onetime/jobs/workers/base_worker'
require_relative '../../../../lib/onetime/jobs/queues/config'
require_relative '../../../../lib/onetime/jobs/queues/declarator'

# Billing-local dependencies
  ...
  module Workers
    class BillingWorker
      ...
      from_queue QUEUE_NAME,
        **Onetime::Jobs::QueueDeclarator.sneakers_options_for(QUEUE_NAME),
