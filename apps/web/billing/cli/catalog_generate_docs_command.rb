...
module Onetime
  module CLI
    ...
    class BillingCatalogGenerateDocsCommand < Command
      ...
      desc 'Generate plan-definitions.md from billing-plans.yaml'
      ...
      def generate_header(catalog)
        <<~MD
          ...
          **Auto-generated from:** `etc/billing/billing-plans.yaml`
          **Schema Version:** #{catalog['schema_version']}
          **Last Updated:** #{Time.now.strftime('%Y-%m-%d %H:%M UTC')}

          ⚠️ **Do not edit this file directly.** Make changes to `etc/billing/billing-plans.yaml` and regenerate with:
          ```bash
      ...
      def generate_validation_section
        <<~MD
          ...
          1. **Edit catalog:** Modify `etc/billing/billing-plans.yaml`
