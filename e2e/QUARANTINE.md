...
| `full-billing/pending-plan-intent.spec.ts` › Post-Verification Redirect (describe, 2 tests) | delano | [#3421](https://github.com/onetimesecret/onetimesecret/issues/3421) | 2026-06-10 | Was `test.skip(() => true, …)` — unconditionally hidden; needs mail interceptor or verification disabled |
