...
Usage:
    python interpolate_product_name.py                  # Dry-run report
    python interpolate_product_name.py --dry-run        # Same as above
    python interpolate_product_name.py --apply          # Apply changes
    python interpolate_product_name.py --locale en      # Single locale
    python interpolate_product_name.py --report-only    # Summary counts only
