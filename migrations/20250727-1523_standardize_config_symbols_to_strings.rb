# migrations/20250727-1523_standardize_config_symbols_to_strings.rb
#
...
#
# Usage:
#   ruby migrations/20250727-1523_standardize_config_symbols_to_strings.rb --dry-run  # Preview changes
#   ruby migrations/20250727-1523_standardize_config_symbols_to_strings.rb --run      # Execute migration
#
...
module Onetime
  class Migration < BaseMigration
    ...
    def prepare
      ...
      @final_static_path = File.join(@base_path, 'etc', 'config.new.yaml')
        ...
        Things to try:
          ...
          3. Look for diagnostic hints.
             Re-run with debug output:
              ...
              $ ONETIME_DEBUG=1 ruby [--run] migrations/20250731-1523_standardize_config_symbols_to_strings.rb
