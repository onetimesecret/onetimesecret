...
# Billing isolation is handled by apps/web/billing/spec/support/billing_isolation.rb
...
# Lives with the billing module - conditionally adds RSpec configuration when RSpec is defined.
