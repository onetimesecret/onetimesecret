...
#     -e CERTIFICATE_EMAIL=björk@example.com \
...
# 'github.com/caddy-dns/', which is obviously invalid. Select a valid
#  repo name from https://github.com/orgs/caddy-dns/repositories
