...
#
# Usage:
#   ruby scripts/upgrades/v0.24.5/03-customdomain/validate_instance_index.rb [OPTIONS]
#
# Options:
#   --dump-file=FILE         V1 dump JSONL (default: data/upgrades/v0.24.5/customdomain/customdomain_dump.jsonl)
...
def parse_args(args)
  ...
  args.each do |arg|
    ...
    when '--help', '-h'
      puts <<~HELP
        Usage: ruby scripts/upgrades/v0.24.5/03-customdomain/validate_instance_index.rb [OPTIONS]
