...
#
# Options:
#   --input-dir=DIR    Input directory with dump files (default: data/upgrades/v0.24.5)
#   --output-dir=DIR   Output directory (default: results, overwrites in place)
#   --execute          Actually write changes (default: dry-run)
#
# Input: data/upgrades/v0.24.5/{model}/{model}_dump.jsonl
# Output: data/upgrades/v0.24.5/{model}/{model}_dump.jsonl (enriched with objid, extid)
#
    ...
    when '--help', '-h'
      puts <<~HELP
        ...
        Options:
          ...
          --output-dir=DIR   Output directory (default: data/upgrades/v0.24.5)
          --execute          Actually write changes (default: dry-run)
          --help             Show this help
