#!/usr/bin/env bash
# scripts/upgrades/v0.24.5/info.sh
#
# Read-only keyspace inspection for v0.24.5 upgrade source and target databases.
...
#
# Usage:
#   scripts/upgrades/v0.24.5/info.sh [OPTIONS]
#
# Options:
...
#
#   # Show source only
#   scripts/upgrades/v0.24.5/info.sh --source --source-url=redis://localhost:6379
#
#   # Show target only
#   scripts/upgrades/v0.24.5/info.sh --target --target-url=redis://localhost:6380
