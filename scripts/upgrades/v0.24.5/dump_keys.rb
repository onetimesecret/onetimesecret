...
# scripts/upgrades/v0.24.5/dump_keys.rb
#
...
#   --output-dir=DIR Output directory (default: data/upgrades/v0.24.5 in project root)
#   --dry-run        Show what would be dumped without writing
#
# Output files per model: data/upgrades/v0.24.5/customer/customer_dump.jsonl, etc.
...
def parse_args(args)
  ...
  args.each do |arg|
    ...
    when '--help', '-h'
      puts <<~HELP
        Usage: ruby scripts/upgrades/v0.24.5/dump_keys.rb [OPTIONS]
        ...
        Output files per model (in subdirectories):
          data/upgrades/v0.24.5/customer/customer_dump.jsonl
          data/upgrades/v0.24.5/customdomain/customdomain_dump.jsonl
          data/upgrades/v0.24.5/metadata/metadata_dump.jsonl
          data/upgrades/v0.24.5/secret/secret_dump.jsonl
          data/upgrades/v0.24.5/feedback/feedback_dump.jsonl
