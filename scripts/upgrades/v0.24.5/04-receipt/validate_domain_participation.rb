...
#
# Usage:
#   ruby scripts/upgrades/v0.24.5/04-receipt/validate_domain_participation.rb [OPTIONS]
#
# Options:
...
def parse_args(args)
  ...
  args.each do |arg|
    ...
    when '--help', '-h'
      puts <<~HELP
        Usage: ruby scripts/upgrades/v0.24.5/04-receipt/validate_domain_participation.rb [OPTIONS]
        ...
        Options:
          ...
          --indexes-file=FILE     Indexes JSONL for jsonl mode
                                  (default: data/upgrades/v0.24.5/metadata/receipt_indexes.jsonl)
