...
#
# Options:
#   --input-file=PATH      Input JSONL file (default: data/upgrades/v0.24.5/metadata/metadata_dump.jsonl)
...
class ReceiptIndexCreator
  DEFAULT_INPUT           = 'data/upgrades/v0.24.5/metadata/metadata_dump.jsonl'
  DEFAULT_OUTPUT_DIR      = 'data/upgrades/v0.24.5/metadata'
  ...
  args.each do |arg|
    ...
    when '--help', '-h'
      puts <<~HELP
        ...
        Options:
          --input-file=PATH      Input JSONL (default: data/upgrades/v0.24.5/metadata/metadata_dump.jsonl)
          --output-dir=DIR       Output directory (default: data/upgrades/v0.24.5/metadata)
