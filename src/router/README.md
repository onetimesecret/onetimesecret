...
(`docs/specs/recipient-disclosure/recipient-disclosure-matrix.html`): _"The URL is the bearer secret
— and it leaks."_
...
`product`/`interval`, a `redirect` path) is fine in the query — it _should_
