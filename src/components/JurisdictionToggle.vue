...
<template>
  <DropdownToggle ref="dropdownRef" ariaLabel="Change jurisdiction">
...
const selectedJurisdiction = ref(''); // jurisdictionStore.determineJurisdiction(cust?.value?.jurisdiction)
