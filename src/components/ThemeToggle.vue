...
<template>
  <button
    ...
    class="size-10 p-1 rounded-md text-gray-500 opacity-80 hover:opacity-100 transition-colors hover:bg-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 inline-flex items-center justify-center"
    :title="
      isDarkMode ? $t('switch-to-blank-mode', ['light']) : $t('switch-to-blank-mode', ['dark'])
    "
