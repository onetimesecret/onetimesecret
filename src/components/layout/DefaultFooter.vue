          ...
          <ul class="space-y-2">
            ...
            <li>
              <a href="https://status.onetimesecret.com/"
                 ...
                 target="_blank" rel="noopener noreferrer">Status</a>
            </li>
          </ul>
        </div>
      ...
      <div class="flex flex-col sm:flex-row justify-between items-center
        ...
        <div v-if="displayToggles"
          ...
          <div class="flex items-center space-x-2">
            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">EU</span>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-slate-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
