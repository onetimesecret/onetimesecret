...
<!--
  ...
  - Wider container (max-w-6xl instead of max-w-2xl)
...
<template>
  <header class="bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-800">
    ...
    <div class="container mx-auto min-w-[320px] max-w-6xl px-4">
      <div class="py-4">
    ...
    <div v-if="authenticated && displayNavigation" class="bg-gray-50 dark:bg-gray-800/50">
      <div class="container mx-auto min-w-[320px] max-w-6xl px-4">
        <ImprovedPrimaryNav />
      </div>
    </div>
