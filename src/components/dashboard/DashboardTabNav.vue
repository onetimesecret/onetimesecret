    ...
    <ul v-if="authenticated" class="text-xl font-brand flex space-x-4">
      ...
      <li>
        ...
        >
          ...
          <span
            class="ml-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full px-2 py-0.5 text-xs font-medium"
          >{{ metadata_record_count }}</span>
        </router-link>
      </li>
      <li v-if="domains_enabled && planAllowsCustomDomains">
        ...
        >
          ...
          <span
            class="ml-2 bg-gray-200 font-medium dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full px-2 py-0.5 text-xs"
          >{{ custom_domains_record_count }}</span>
        </router-link>
      </li>
    </ul>
  </nav>
