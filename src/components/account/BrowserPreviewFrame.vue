<template>
  <div class="relative overflow-hidden rounded-xl border border-gray-200 shadow-2xl dark:border-gray-700">
    <!-- Browser Top Bar -->
    <div v-if="browserType === 'safari'" class="flex items-center space-x-2 p-3 border-b border-gray-200 bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
      <!-- Safari Controls -->
      ...
      <div class="flex-1 mx-4">
        <div class="flex items-center justify-between px-3 py-1.5 rounded-md text-sm bg-white text-gray-600 dark:bg-gray-700 dark:text-gray-300">
          <div class="flex items-center">
            <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
            <span class="text-green-400">https://</span>
            <span class="font-bold">{{ domain }}</span>
            <span class="opacity-50">/secret/abcd1234</span>
          </div>
          <!-- Preview Badge - Safari -->
          <span class="inline-flex items-center px-2 py-0.5 ml-3 rounded text-xs font-medium bg-brandcomp-100 text-brand-800 dark:bg-brandcomp-900 dark:text-brandcomp-200">
    ...
    <div v-else class="flex flex-col border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="flex items-center justify-between px-4 py-2 bg-gray-100 dark:bg-gray-900">
        <div class="flex items-center space-x-2">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 16 16">
            <g fill="currentColor" class="text-gray-600 dark:text-gray-300">
      ...
      <div class="flex items-center px-4 py-2">
        <div class="flex items-center justify-between flex-1 px-3 py-1.5 rounded-lg text-sm bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300">
          <div class="flex items-center">
            ...
            <span class="text-green-400">https://</span>
            <span class="font-bold">{{ domain }}</span>
            <span class="opacity-50">/secret/abcdef0123456789</span>
          </div>
          <!-- Preview Badge - Edge -->
          <span class="inline-flex items-center px-2 py-0.5 ml-3 rounded text-xs font-medium bg-brandcomp-100 text-brand-800 dark:bg-brandcomp-900 dark:text-brandcomp-200">
            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
