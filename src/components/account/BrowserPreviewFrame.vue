  ...
  <div class="relative overflow-hidden rounded-xl border border-gray-200 shadow-2xl dark:border-gray-700">
    ...
    <div v-if="browserType === 'safari'" class="flex items-center space-x-2 p-3 border-b border-gray-200 bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="flex-1 mx-4">
        <div class="flex items-center px-3 py-1.5 rounded-md text-sm bg-white text-gray-600 dark:bg-gray-700 dark:text-gray-300">
    ...
    <div v-else class="flex flex-col border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="flex items-center px-4 py-2">
        <div class="flex-1 flex items-center px-3 py-1.5 rounded-lg text-sm bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300">
    ...
    <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 z-10 opacity-60">
      <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-medium bg-brandcomp-100 text-brand-800 shadow-sm dark:bg-brandcomp-900 dark:text-brandcomp-200">
