<!-- src/components/icons/OnetimeSecretLogoBrandmark.vue -->
...
<div class="">
  <div class="relative">
    ...
    <!-- Logomark jurisdiction selector -->
    <div
    ...
    <div class="ml-3 flex flex-col">
      ...
      <span class="text-xs text-gray-500 dark:text-gray-400" aria-hidden="true">
        ...
        <span class="group/tooltip relative inline-block">
          ...
          <span
            class="absolute left-full top-0 ml-1 hidden w-max rounded bg-gray-200/80 px-2 py-1
