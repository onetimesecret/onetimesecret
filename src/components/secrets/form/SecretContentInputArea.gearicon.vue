...
<template>
  <div class="relative">
    <textarea
      class="h-48 w-full rounded-md border border-gray-300 p-3 focus:border-brandcompdim-500 focus:ring-brandcompdim-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
      name="secret"
      autofocus
      autocomplete="off"
      placeholder="Secret content goes here..."
      aria-label="Enter the secret content here"
    ></textarea>
    <div
      class="absolute bottom-4 right-2 transition-opacity duration-200"
    ...
    >
      ...
      >
        <button
          type="button"
          class="inline-flex items-center justify-center rounded-full border border-gray-300 bg-white p-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brandcomp-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:ring-offset-gray-800"
        ...
        >
          ...
          >
            ...
            >
              <div class="px-4 py-2 font-brand text-sm font-semibold text-gray-700 dark:text-gray-300">
                Select Domain
              </div>
              <a
