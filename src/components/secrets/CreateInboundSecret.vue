...
<template>
  ...
  <form id="createSecret"
    ...
    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
      <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">{{ $t('web.incoming.incoming_secret_options') }}</h3>

      <div class="space-y-4">
        <div>
          <label for="ticketnoField"
                 class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ $t('web.incoming.incoming_ticket_number') }}:</label>
          <input type="text"
                 name="ticketno"
                 id="ticketnoField"
        ...
        <div>
          <label for="recipientField"
                 class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ $t('web.incoming.incoming_recipient_address') }}:</label>
    ...
    <button type="submit"
      ...
      {{ $t('web.incoming.incoming_button_create') }}
    </button>
  </form>
