...
<!--
  ...
  License: MIT
  Source: https://github.com/tabler/tabler-icons/blob/master/LICENSE

  Usage:
      <svg>
        <use href="#tabler-square-letter-s"></use>
      </svg>
-->
    ...
    <defs>
      <symbol
        ...
        <g
          ...
          <path d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0-2 0m-3-5V7a4 4 0 1 1 8 0v4m-1 8l2 2l4-4" />
        </g>
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="tabler-lock-cancel">
        <g
          fill="none"
          stroke="currentColor"
          stroke-linecap="round"
          ...
          <path
            d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0-2 0m-3-5V7a4 4 0 1 1 8 0v4m0 8a3 3 0 1 0 6 0a3 3 0 1 0-6 0m1 2l4-4" />
        </g>
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="tabler-lock-password">
        <path
          fill="none"
          stroke="currentColor"
          stroke-linecap="round"
      ...
      <symbol
        ...
        <g
          ...
          <path
            d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0-2 0m-3-5V8m.719-3.289A4 4 0 0 1 16 7v4M3 3l18 18" />
        </g>
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        ...
        <g
          ...
          <path d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0-2 0m-3-5V7a4 4 0 1 1 8 0v4m0 8h6m-3-3v6" />
        </g>
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="tabler-lock-minus">
        <g
          fill="none"
          stroke="currentColor"
          stroke-linecap="round"
          ...
          <path d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0-2 0m-3-5V7a4 4 0 1 1 8 0v4m0 8h6" />
        </g>
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        ...
        <g
          ...
          stroke-width="2">
          <path
            d="M11.5 21H7a2 2 0 0 1-2-2v-6a2 2 0 0 1 2-2h10c.38 0 .734.106 1.037.29M8 11V7a4 4 0 1 1 8 0v4" />
          <path
