  ...
  <svg
    ...
    <defs>
      ...
      <symbol
        ...
        <path
          fill="currentColor"
          d="m2.79 4.46l.71-.71L20.25 20.5l-.71.71L14.33 16H12v4.5l-.5 1.5l-.5-1.5V16H6v-2l2-2V9.66zM14 12.41V5h1V4H8v1h1v2.84l-1-1V6h-.84L7 5.84V3h9v3h-1v6l2 2v1.83l-1-.99v-.43zm-5 0l-2 2V15h6.34L9 10.66z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
      ...
      <symbol
        viewBox="0 0 24 24"
        id="mdi-account-supervisor-circle">
        <path
          fill="currentColor"
      ...
      <symbol
        viewBox="0 0 24 24"
        id="mdi-account-supervisor-outline">
        <path
          fill="currentColor"
      ...
      <symbol
        ...
        <path
          fill="currentColor"
          d="M4 2v6H2V2zM2 22v-6h2v6zm3-10c0 1.11-.89 2-2 2a2 2 0 1 1 2-2m19-6v12c0 1.11-.89 2-2 2H10a2 2 0 0 1-2-2v-4l-2-2l2-2V6a2 2 0 0 1 2-2h12c1.11 0 2 .89 2 2M10 6v12h12V6zm5 1h2v6h-2zm0 8h2v2h-2z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-check-outline">
        <path
          fill="currentColor"
          d="M22 4H10a2 2 0 0 0-2 2v4l-2 2l2 2v4a2 2 0 0 0 2 2h12c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2m0 14H10V6h12zM4 8H2V2h2zm-2 8h2v6H2zm3-4c0 1.11-.89 2-2 2a2 2 0 1 1 2-2m10 3.08l-2.75-3l1.16-1.16L15 12.5l3.59-3.58l1.16 1.41z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-clock">
        <path
          fill="currentColor"
          d="M4 2v6H2V2zM2 22v-6h2v6zm3-10c0 1.11-.89 2-2 2a2 2 0 1 1 2-2m11-8c4.42 0 8 3.58 8 8s-3.58 8-8 8c-3.6 0-6.64-2.38-7.65-5.65L6 12l2.35-2.35C9.36 6.38 12.4 4 16 4m-1 9l4.53 2.79l.8-1.29l-3.83-2.3V7H15z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-clock-outline">
        <path
          fill="currentColor"
      ...
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-minus-outline">
        <path
          fill="currentColor"
          d="M2 16h2v6H2zM4 2H2v6h2zm16 9h-8v2h8zM3 10a2 2 0 1 0 0 4c1.11 0 2-.89 2-2a2 2 0 0 0-2-2m21-4v12c0 1.11-.89 2-2 2H10a2 2 0 0 1-2-2v-4l-2-2l2-2V6a2 2 0 0 1 2-2h12c1.11 0 2 .89 2 2m-2 0H10v12h12z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-outline">
        <path
          fill="currentColor"
          d="M4 2v6H2V2zM2 22v-6h2v6zm3-10c0 1.11-.89 2-2 2a2 2 0 1 1 2-2m19-6v12c0 1.11-.89 2-2 2H10a2 2 0 0 1-2-2v-4l-2-2l2-2V6a2 2 0 0 1 2-2h12c1.11 0 2 .89 2 2M10 6v12h12V6z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-plus-outline">
        <path
          fill="currentColor"
          d="M4 2v6H2V2zM2 22v-6h2v6zm3-10c0 1.11-.89 2-2 2a2 2 0 1 1 2-2m15-1v2h-3v3h-2v-3h-3v-2h3V8h2v3zm4-5v12c0 1.11-.89 2-2 2H10a2 2 0 0 1-2-2v-4l-2-2l2-2V6a2 2 0 0 1 2-2h12c1.11 0 2 .89 2 2M10 6v12h12V6z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-question-outline">
        <path
          fill="currentColor"
          d="M5 12c0 1.11-.89 2-2 2a2 2 0 1 1 2-2M4 2v6H2V2zM2 22v-6h2v6zM24 6v12c0 1.11-.89 2-2 2H10a2 2 0 0 1-2-2v-4l-2-2l2-2V6a2 2 0 0 1 2-2h12c1.11 0 2 .89 2 2m-2 0H10v4.83L8.83 12L10 13.17V18h12zm-5.5 9.5V17H15v-1.5zm-2-5H13V10c0-1.66 1.34-3 3-3s3 1.34 3 3c0 .97-.5 1.88-1.29 2.41l-.3.19c-.57.4-.91 1.02-.91 1.7v.2H15v-.2c0-1.19.6-2.3 1.59-2.95l.29-.19c.39-.26.62-.69.62-1.16c0-.82-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-remove-outline">
        <path
          fill="currentColor"
          d="M4 8H2V2h2zM2 22h2v-6H2zm1-12a2 2 0 1 0 0 4c1.11 0 2-.89 2-2a2 2 0 0 0-2-2m10.88 5.54L16 13.41l2.12 2.12l1.41-1.41L17.41 12l2.12-2.12l-1.41-1.41L16 10.59l-2.12-2.12l-1.41 1.41L14.59 12l-2.12 2.12zM24 6v12c0 1.11-.89 2-2 2H10a2 2 0 0 1-2-2v-4l-2-2l2-2V6a2 2 0 0 1 2-2h12c1.11 0 2 .89 2 2m-2 0H10v12h12z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-timeline-text-outline">
        <path
          fill="currentColor"
          d="M5 12c0 1.11-.89 2-2 2a2 2 0 1 1 2-2M4 2v6H2V2zM2 22v-6h2v6zM24 6v12c0 1.11-.89 2-2 2H10a2 2 0 0 1-2-2v-4l-2-2l2-2V6a2 2 0 0 1 2-2h12c1.11 0 2 .89 2 2m-2 0H10v4.83L8.83 12L10 13.17V18h12zM12 9h8v2h-8zm0 4h6v2h-6z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-open-in-new">
      ...
      <symbol
        ...
        <path
          fill="currentColor"
          d="M12 19h4l-2-2h-2zm-2-4v-2H8v2zm0 4v-2H8v2zm-4-8V9H4v2zm0 4v-2H4v2zm0 4v-2H4v2zM1.31 1.78l21 20.91L21 24l-3-3H2V5L.09 3.09zM16 11h2v2h-2zM8 5v.91L5.11 3H12v4h10v12.92l-2-2.01V9h-8v.89L9.09 7H10V5z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-eye">
      ...
      <symbol
        ...
        <path
          fill="currentColor"
          d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12c5.16-1.26 9-6.45 9-12V5zm3.97 13.41c-1.84 2.17-5.21 2.09-6.97-.07c-2.18-2.72-.64-6.72 2.7-7.34c.34-.05.63.28.51.61c-.46 1.23-.39 2.64.32 3.86a4.51 4.51 0 0 0 3.18 2.2c.34.05.49.47.26.74" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-shield-off">
      ...
      <symbol
        viewBox="0 0 24 24"
        id="mdi-text-box-minus">
        <path
          fill="currentColor"
          d="M22 17v2h-8v-2zm-10 0v-2H7v2zm5-6H7v2h7.69A5.98 5.98 0 0 0 12 18c0 1.09.29 2.12.8 3H5a2 2 0 0 1-2-2V5c0-1.11.89-2 2-2h14a2 2 0 0 1 2 2v7.8c-.88-.51-1.91-.8-3-.8l-1 .08zm0-2V7H7v2z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-text-box-minus-outline">
        <path
          fill="currentColor"
          d="M22 17v2h-8v-2zM5 3h14c1.11 0 2 .89 2 2v7.8c-.61-.35-1.28-.6-2-.72V5H5v14h7.08c.12.72.37 1.39.72 2H5c-1.11 0-2-.89-2-2V5c0-1.11.89-2 2-2m2 4h10v2H7zm0 4h10v1.08c-.85.14-1.63.46-2.32.92H7zm0 4h5v2H7z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
      ...
      <symbol
        viewBox="0 0 24 24"
        id="mdi-text-box-plus">
        <path
          fill="currentColor"
          d="M17 14h2v3h3v2h-3v3h-2v-3h-3v-2h3zm-5 3v-2H7v2zm5-6H7v2h7.69A5.98 5.98 0 0 0 12 18c0 1.09.29 2.12.8 3H5a2 2 0 0 1-2-2V5c0-1.11.89-2 2-2h14a2 2 0 0 1 2 2v7.8c-.88-.51-1.91-.8-3-.8l-1 .08zm0-2V7H7v2z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
      ...
      <symbol
        viewBox="0 0 24 24"
        id="mdi-text-box-remove">
        <path
          fill="currentColor"
          d="m14.46 15.88l1.42-1.42L18 16.59l2.12-2.13l1.42 1.42L19.41 18l2.13 2.12l-1.42 1.42L18 19.41l-2.12 2.13l-1.42-1.42L16.59 18zM12 17v-2H7v2zm5-6H7v2h7.69A5.98 5.98 0 0 0 12 18c0 1.09.29 2.12.8 3H5a2 2 0 0 1-2-2V5c0-1.11.89-2 2-2h14a2 2 0 0 1 2 2v7.8c-.88-.51-1.91-.8-3-.8l-1 .08zm0-2V7H7v2z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-text-box-remove-outline">
        <path
          fill="currentColor"
          d="m14.46 15.88l1.42-1.42L18 16.59l2.12-2.13l1.42 1.42L19.41 18l2.13 2.12l-1.42 1.42L18 19.41l-2.12 2.13l-1.42-1.42L16.59 18zM5 3h14c1.11 0 2 .89 2 2v7.8c-.61-.35-1.28-.6-2-.72V5H5v14h7.08c.12.72.37 1.39.72 2H5c-1.11 0-2-.89-2-2V5c0-1.11.89-2 2-2m2 4h10v2H7zm0 4h10v1.08c-.85.14-1.63.46-2.32.92H7zm0 4h5v2H7z" />
      </symbol>
      <symbol
        viewBox="0 0 24 24"
        id="mdi-trash-can">
      ...
      <!-- SSO provider brand marks (monochrome, currentColor) used by SsoButton -->
      <symbol
        viewBox="0 0 24 24"
        id="mdi-google">
        <!-- Icon from Material Design Icons by Pictogrammers -->
