...
<template>
  <div class="inline-flex items-center">
    <span
      v-if="props.onLabel || props.offLabel"
    ...
    <Switch
      ...
      :class="[
        ...
        'relative inline-flex h-6 w-11 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 focus:outline-none',
      ]">
