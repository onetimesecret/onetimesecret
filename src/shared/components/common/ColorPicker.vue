...
<script setup lang="ts">
  ...
  import { ChromePicker, SketchPicker, CompactPicker, tinycolor } from 'vue-color';
    ...
    <div
      ...
      <div class="relative flex items-center">
        ...
        <input
          ...
          :value="displayHex"
          :name="name"
          class="w-[5.5rem] border-none bg-transparent p-0 pl-1 text-sm font-medium text-gray-900 uppercase placeholder:text-gray-400 focus:ring-0 dark:text-gray-100"
