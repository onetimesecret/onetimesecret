 ...
 *
 * Mutable Config Schema (mutableConfigSchema):
 ...
 *
 * Design Principle:
 * The configuration system keeps static and mutable config separate,
 * then combines them when the app runs. Static settings always win if
 * there's a conflict - mutable config can't override them. The final
