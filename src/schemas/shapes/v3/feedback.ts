 ...
 */
export const feedbackRecord = feedbackCanonical.extend({
 ...
 */
export const feedbackDetails = feedbackDetailsCanonical.extend({
  received: z
    .boolean()
    .nullable()
    .transform((v) => v ?? false),
...
export type FeedbackDetails = z.infer<typeof feedbackDetails>;
