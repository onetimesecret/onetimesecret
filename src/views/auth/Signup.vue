    ...
    <div class="max-w-md w-full space-y-8">
      <div class="flex flex-col items-center">
        ...
        <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
          Create your account in {{ currentRegion.display_name }}
        </p>
      </div>
      ...
      <div class="mt-8 space-y-6">
        ...
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-gray-100 dark:bg-gray-900 text-gray-500 dark:text-gray-400">
              Or continue with
            </span>
          </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-3">
          <button v-for="provider in socialProviders"
                  :key="provider.name"
                  class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
            <span class="sr-only">Sign up with {{ provider.name }}</span>
