        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <div class="flex items-center">
                ...
                <p class="ml-3 text-gray-800 dark:text-gray-200">
                  Sessions:
                  <span class="text-lg font-bold">{{ details?.counts.session_count }}</span
            ...
            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-gray-200">
              {{
                t('web.colonel.secrets-details-counts-secret_count-0', [
          ...
          <div
            ...
            class="mb-8">
            <h3
              class="mb-2 mt-6 flex items-center text-xl font-bold text-gray-800 dark:text-gray-200">
              {{ t('redis-info') }}
              <a
                href="#"
                class="ml-2"
