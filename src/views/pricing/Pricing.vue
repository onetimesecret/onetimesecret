  ...
  <div class="isolate overflow-hidden bg-gray-900 dark:bg-gray-950">
    <div class="mx-auto max-w-7xl px-6 pb-96 pt-24 text-center sm:pt-32 lg:px-8">
      <div class="mx-auto max-w-4xl">
        <h2 class="text-base font-semibold leading-7 text-indigo-400 dark:text-indigo-300">
          Pricing
        </h2>
        <p class="mt-2 font-brand text-4xl font-bold tracking-tight text-white sm:text-5xl">
        ...
        <fieldset aria-label="Payment frequency">
          <RadioGroup
            ...
            <RadioGroupOption
              ...
              :value="option"
              v-slot="{ checked }">
              <div :class="[checked ? 'bg-indigo-600 text-white' : 'text-gray-500 dark:text-gray-400', 'cursor-pointer rounded-full px-2.5 py-1']">
                {{ option.label }}
              </div>
            </RadioGroupOption>
          </RadioGroup>
      ...
      <div class="relative mt-6">
        <p class="mx-auto max-w-2xl text-lg leading-8 text-white/60 dark:text-white/70">
          ...
          <div class="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
            <div
              ...
              <div>
                ...
                <div class="mt-4 flex items-baseline gap-x-2">
                  <span class="font-brand text-5xl font-bold tracking-tight text-gray-900 dark:text-white">{{ tier.priceMonthly }}</span>
                  <span class="font-brand text-base font-semibold leading-7 text-gray-600 dark:text-gray-400">/month</span>
                </div>
              ...
              <a
                ...
                class="mt-8 block rounded-md bg-indigo-600 px-3.5 py-2 text-center text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:hover:bg-indigo-400">Get started today</a>
            </div>
            <div class="flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl p-8 ring-1 ring-gray-900/10 dark:ring-gray-700 sm:gap-y-10 sm:p-10 lg:col-span-2 lg:flex-row lg:items-center">
              <div class="lg:min-w-0 lg:flex-1">
                <h3 class="text-lg font-semibold leading-8 tracking-tight text-indigo-600 dark:text-indigo-400">
                  Discounted
                </h3>
                <p class="mt-1 text-base leading-7 text-gray-600 dark:text-gray-300">
