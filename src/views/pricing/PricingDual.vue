    ...
    >
      ...
      >
        ...
        <p class="mt-4 flex items-baseline gap-x-2">
          <span
            :class="[tier.featured ? 'text-white blur-lg' : 'text-gray-900 dark:text-white', 'text-5xl font-bold tracking-tight']"
          >{{ tier.price[frequency.value] }}</span>
          <span
            :class="[tier.featured ? 'text-gray-400' : 'text-gray-500 dark:text-gray-400', 'text-base']"
