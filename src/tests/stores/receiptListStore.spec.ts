...
import {
  mockReceiptRecent,
  mockReceiptRecentDetails,
  mockReceiptRecentRecords,
} from '../fixtures/receipt.fixture';

describe('receiptListStore', () => {
  let axiosMock: AxiosMockAdapter;
  let api: ReturnType<typeof createApi>;
  let store: ReturnType<typeof useReceiptListStore>;
  ...
  describe('fetchList', () => {
    it('should fetch and store list of metadata records', async () => {
      const mockResponse = {
        ...
        count: 2,
        records: [
          mockReceiptRecent.records[0],
          { ...mockReceiptRecent.records[0], key: 'key456', shortid: 'short456' },
        ],
        details: mockReceiptRecent.details,
      };
  ...
  describe('loading state', () => {
    it('successfully fetches data with async operation', async () => {
      const mockResponse = {
        custid: 'user-123',
        count: 2,
        records: [mockReceiptRecent.records[0]],
        details: mockReceiptRecent.details,
      };
  ...
  describe('metadataStore error handling and loading states', () => {
    ...
    describe('loading state transitions', () => {
      it('follows correct loading state sequence for successful request', async () => {
        ...
        // const mockResponse = {
        //   record: mockReceiptRecentRecords,
        //   details: mockReceiptRecentDetails,
        // };
