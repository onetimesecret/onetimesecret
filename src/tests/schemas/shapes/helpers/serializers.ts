...
// Converts canonical (post-parse) receipt data back to wire formats.
//
// Wire format differences:
//   V2: created/updated are numbers, other timestamps are strings, booleans/numbers are strings
