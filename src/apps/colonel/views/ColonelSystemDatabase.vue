    ...
    <div v-else-if="databaseMetrics">
      <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
          Redis database information and statistics
        </p>
      </div>

      <!-- Redis Info -->
      <div class="mb-6 rounded-lg bg-white p-6 dark:bg-gray-800">
        <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Redis Server</h2>
      ...
      <!-- Memory Stats -->
      <div class="mb-6 rounded-lg bg-white p-6 dark:bg-gray-800">
        <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Memory</h2>
        <div class="grid grid-cols-2 gap-4 md:grid-cols-3">
          <div>
      ...
      <!-- Database Sizes -->
      <div class="mb-6 rounded-lg bg-white p-6 dark:bg-gray-800">
        <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Databases</h2>
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div
            ...
            <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
              {{ getDbKeys(dbInfo).toLocaleString() }} keys,
              {{ getDbExpires(dbInfo).toLocaleString() }} with TTL
            </div>
          </div>
        </div>
      ...
      <div class="rounded-lg bg-white p-6 dark:bg-gray-800">
        <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Model Counts</h2>
