            ...
            <div class="flex items-center justify-between">
              ...
              <button
                ...
                :class="[
                  ...
                  'relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
                ]"
                :aria-busy="isLoading">
                <span
                  aria-hidden="true"
