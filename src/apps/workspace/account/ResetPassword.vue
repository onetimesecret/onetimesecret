          ...
          <h3 class="text-base leading-6 font-semibold text-gray-900 dark:text-white">
            {{
              hasPw
                ...
                : t('web.auth.password_setup_request.title')
            }}
          </h3>
            ...
            <p>
              {{
                hasPw
                  ...
                  : t('web.auth.password_setup_request.description')
              }}
            </p>
          </div>
          ...
          <form
            ...
            <div>
              ...
              <div class="mt-1">
                <input
                  ...
                  class="block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm sm:text-sm dark:border-gray-600 dark:bg-gray-700/50 dark:text-gray-300" />
              </div>
            </div>
            ...
            <div class="flex justify-end">
              <button
                ...
                <span v-else>{{
                  hasPw
                    ? t('web.auth.password_reset_request.button')
                    : t('web.auth.password_setup_request.button')
                }}</span>
              </button>
            </div>
          </form>
