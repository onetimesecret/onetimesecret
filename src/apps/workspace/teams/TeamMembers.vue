<!-- src/apps/workspace/teams/TeamMembers.vue -->

<script setup lang="ts">
  import { useI18n } from 'vue-i18n';
  import BasicFormAlerts from '@/shared/components/forms/BasicFormAlerts.vue';
  import OIcon from '@/shared/components/icons/OIcon.vue';
  import TeamMembersList from '@/apps/workspace/components/teams/TeamMembersList.vue';
  ...
  const canManageMembers = computed(() => {
    ...
    return (
      activeTeam.value.current_user_role === TeamRole.OWNER ||
      activeTeam.value.current_user_role === TeamRole.ADMIN
    );
  });
          ...
          <div>
            ...
            <select
              ...
              <option :value="TeamRole.MEMBER">
                {{ t('web.teams.roles.member') }}
              </option>
              <option
                v-if="activeTeam?.current_user_role === TeamRole.OWNER"
