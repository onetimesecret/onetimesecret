<!-- src/apps/workspace/teams/TeamSettings.vue -->
...
<template>
  <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div
      ...
      <!-- Danger Zone -->
      <div
        class="rounded-lg border border-red-200 bg-white shadow-sm dark:border-red-900 dark:bg-gray-800">
          ...
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{
                  activeTeam?.is_default
                    ? t('web.teams.delete_default_team_warning')
