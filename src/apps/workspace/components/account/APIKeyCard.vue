  ...
  <div
    ...
    <div class="font-mono text-sm text-gray-800 dark:text-gray-200">
      <div
        ...
        <span class="pr-10 break-all">{{ maskedToken }}</span>
        <button
          @click.stop="handleCopy"
          type="button"
          class="absolute top-1/2 right-2 -translate-y-1/2 text-gray-400 transition-colors duration-200 hover:text-brand-600 dark:text-gray-500 dark:hover:text-brand-400">
          <OIcon
