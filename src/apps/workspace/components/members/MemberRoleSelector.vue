...
<script setup lang="ts">
  ...
  const selectedRole = computed(
    () => allRoles.find((r) => r.value === props.modelValue) ?? allRoles[2]
  );
...
<template>
  <div class="relative">
    ...
    <Listbox
      ...
      <div class="relative">
        <ListboxButton
          class="relative w-full cursor-pointer rounded-md border border-gray-300 bg-white py-1.5 pr-10 pl-3 text-left text-sm shadow-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:focus:border-brand-400 dark:focus:ring-brand-400">
