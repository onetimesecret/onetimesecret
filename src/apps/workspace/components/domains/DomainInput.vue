  ...
  <div>
    <div class="relative mt-2 rounded-md shadow-sm">
      <input
        ...
        @input="onInput"
        :class="ringClasses"
        class="block w-full rounded-md border-0 py-3 pr-10 pl-5 text-xl text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400" />
