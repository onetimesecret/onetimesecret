            ...
            <DialogPanel
              ...
              <div class="mt-6 sm:flex sm:flex-row-reverse sm:gap-3">
                <button
                  v-if="refundFailed"
                  type="button"
                  class="inline-flex w-full justify-center rounded-md bg-brand-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-brand-500 sm:w-auto dark:bg-brand-500 dark:hover:bg-brand-400"
