  ...
  <BillingLayout>
    <div class="space-y-6">
      ...
      <div
        ...
        class="overflow-hidden rounded-lg border border-gray-200/60 bg-white/60 shadow-sm backdrop-blur-sm dark:border-gray-700/60 dark:bg-gray-800/60">
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
              <tr
                ...
                <td
                  class="px-6 py-4 font-mono text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
