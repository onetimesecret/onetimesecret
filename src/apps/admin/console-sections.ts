...
export const CONSOLE_GROUPS: { key: ConsoleGroup; labelKey: string }[] = [
  ...
  { key: 'comms', labelKey: 'web.colonel.nav.groups.communications' },
];

export const CONSOLE_SECTIONS: ConsoleSection[] = [
  { key: 'overview', labelKey: 'web.colonel.titles.index', icon: 'home', group: 'overview', to: '/colonel' },

  { key: 'customers', labelKey: 'web.colonel.titles.users', icon: 'users', group: 'identity', to: '/colonel/customers' },
  { key: 'organizations', labelKey: 'web.colonel.titles.organizations', icon: 'building-office', group: 'identity', to: '/colonel/organizations' },
  { key: 'sessions', labelKey: 'web.admin.sessions.title', icon: 'finger-print', group: 'identity', to: '/colonel/sessions' },
  { key: 'secrets', labelKey: 'web.colonel.titles.secrets', icon: 'key', group: 'identity', to: '/colonel/secrets' },

  { key: 'auditLog', labelKey: 'web.admin.audit.title', icon: 'document-text', group: 'security', to: '/colonel/audit' },
  { key: 'bannedIps', labelKey: 'web.colonel.titles.bannedIps', icon: 'no-symbol', group: 'security', to: '/colonel/banned-ips' },

  { key: 'system', labelKey: 'web.colonel.titles.system', icon: 'cog-6-tooth', group: 'platform', to: '/colonel/system' },
  { key: 'domains', labelKey: 'web.colonel.titles.domains', icon: 'globe-alt', group: 'platform', to: '/colonel/domains' },
  { key: 'domaintoolbox', labelKey: 'web.admin.domaintoolbox.title', icon: 'shield-exclamation', group: 'platform', to: '/colonel/domain-toolbox' },
  { key: 'emailTools', labelKey: 'web.admin.emailtools.title', icon: 'envelope', group: 'platform', to: '/colonel/email-tools' },

  { key: 'billing', labelKey: 'web.admin.billing.title', icon: 'credit-card', group: 'billing', to: '/colonel/billing' },
  { key: 'usage', labelKey: 'web.colonel.titles.usage', icon: 'rectangle-group', group: 'billing', to: '/colonel/usage' },

  { key: 'banner', labelKey: 'web.admin.banner.title', icon: 'bell', group: 'comms', to: '/colonel/banner' },
];
