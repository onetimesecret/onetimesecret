...
<script setup lang="ts">
  ...
  const isExpired = computed(
    () => props.secretReceipt.is_expired || props.secretReceipt.secret_ttl <= 0
  );
      ...
      <div class="relative flex items-start gap-2">
        ...
        <div
          ...
          <router-link
            ...
            class="rounded border border-red-300 bg-red-50 p-1.5 text-red-700 transition-colors hover:bg-red-100 sm:px-2 sm:py-0.5 dark:border-red-700 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-900/50"
