...
// Generated at: 2026-01-10T04:02:02.592Z
...
export type I18nKey =
  ...
  | 'web.TITLES.colonel_organizations'
  | 'web.TITLES.colonel_redis'
  ...
  | 'web.auth.password_reset._context'
  | 'web.auth.password_reset.description'
  | 'web.auth.password_reset.title'
  | 'web.auth.password_reset_request._context'
  ...
  | 'web.feedback.a_note_from_delano_founder_of_onetime_secret'
  ...
  | 'web.feedback.hey_there_thanks_for_stopping_by_our_feedback_pa'
...
export interface LocaleMessageSchema {
  ...
  web: {
    ...
    TITLES: {
      ...
      colonel_organizations: string;
      colonel_redis: string;
    ...
    feedback: {
      a_note_from_delano_founder_of_onetime_secret: string;
      ...
      hey_there_thanks_for_stopping_by_our_feedback_pa: string;
