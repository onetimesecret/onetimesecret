...
logic = V1::Logic::Secrets::ConcealSecret.new @sess, @cust, {secret: @secret_params}
[
  logic.secret_value,
  logic.passphrase,
  logic.ttl,
...
logic = V1::Logic::Secrets::ShowSecret.new @sess, @cust, @view_params
...
logic = V1::Logic::Secrets::RevealSecret.new @sess, @cust, @view_params
[logic.key, logic.passphrase]
#=> [@secret.key, 'testpass123']
...
logic = V1::Logic::Secrets::ShowMetadata.new @sess, @cust, { key: @metadata.key }
...
logic = V1::Logic::Secrets::ShowMetadataList.new @sess, @cust
...
## Test secret burning
logic = V1::Logic::Secrets::BurnSecret.new @sess, @cust, @view_params
[logic.key, logic.passphrase]
#=> [@secret.key, 'testpass123']
