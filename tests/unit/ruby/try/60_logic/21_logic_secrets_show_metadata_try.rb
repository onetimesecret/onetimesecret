...
params = {}
logic = V2::Logic::Secrets::ShowMetadata.new(@sess, @cust, params, 'en')
...
@this_logic = V2::Logic::Secrets::ShowMetadata.new(@sess, @cust, params, 'en')
...
logic = V2::Logic::Secrets::ShowMetadata.new(@sess, @cust, {}, 'es')
logic.locale
#=> 'es'

## Falls back to nil locale if not provided
logic = V2::Logic::Secrets::ShowMetadata.new(@sess, @cust, {}, nil)
logic.locale
#=> nil
...
logic = V2::Logic::Secrets::ShowMetadata.new(@sess, @cust, {}, 'en')
logic.one_liner
#=> nil
