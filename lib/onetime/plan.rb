...
module Onetime
  class Plan
    ...
    module ClassMethods
      ...
      def load_plans!
        add_plan :anonymous, 0, 0, ttl: 30.days, size: 100_000, api: false, name: 'Anonymous'
        add_plan :basic, 0, 0, ttl: 30.days, size: 1_000_000, api: true, name: 'Basic Plan', email: true, custom_domains: false, dark_mode: true
