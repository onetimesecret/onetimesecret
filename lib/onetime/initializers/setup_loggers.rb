...
module Onetime
  module Initializers
    ...
    class SetupLoggers < Onetime::Boot::Initializer
      ...
      def apply_logger_level_overrides(cached_loggers)
        ...
        apply_quick_debug_flag(cached_loggers, 'App',     ENV.fetch('DEBUG_APP', nil))
        ...
        apply_quick_debug_flag(cached_loggers, 'Sequel',  ENV.fetch('DEBUG_SEQUEL', nil))

        # Setting DEBUG_SESSION also enables SessionDebugger middleware
        apply_quick_debug_flag(cached_loggers, 'Session', ENV.fetch('DEBUG_SESSION', nil))
      ...
      def apply_quick_debug_flag(cached_loggers, logger_name, env_value)
      ...
      def configure_external_loggers(cached_loggers)
        ...
        configure_familia_hooks(cached_loggers)
      end
      ...
      # capture for tests.
      #
      def configure_familia_hooks(cached_loggers)
