  ...
  module Initializers
    module SetupSystemSettings
      ...
      def self.run(options = {})
        ...
        OT.instance_variable_set(:@first_boot, is_first_boot)
        ...
        OT.ld "[initializer] System settings setup completed"
      ...
      def self.create_initial_system_settings
      ...
      def self.apply_system_settings(system_settings)
