...
module Onetime
  module Http
    ...
    module Guard
      ...
      # 192.0.2.0/24, 198.51.100.0/24 and 203.0.113.0/24 are the RFC 5737
      # TEST-NET documentation ranges — never globally routed, so no legitimate
      # egress host resolves into them; blocking them is fail-closed hardening.
      BLOCKED_V4 = %w[
