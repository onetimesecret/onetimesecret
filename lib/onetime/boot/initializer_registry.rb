...
module Onetime
  module Boot
    ...
    class InitializerRegistry
      extend TSort   # Class-level TSort (backward compatibility)
      include TSort  # Instance-level TSort (new architecture)

      # Class-level state (backward compatibility - will be removed in Phase 3)
