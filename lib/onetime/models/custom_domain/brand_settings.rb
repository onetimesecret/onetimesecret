...
module Onetime
  class CustomDomain
    ...
    module BrandSettingsConstants
      ...
      #
      # primary_color is a neutral blue (#3B82F6) per #3049 — keeps shipped
      # defaults brand-agnostic so private-label/self-hosted instances don't
      # accidentally render OTS orange. Operators set BRAND_PRIMARY_COLOR to
      # override; per-domain Redis branding overrides both.
      DEFAULTS = {
        font_family: 'sans',
