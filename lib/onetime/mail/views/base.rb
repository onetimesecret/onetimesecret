      ...
      class Base < Chimera
        ...
        def deliver_email token=nil
          ...
          internal_emsg = "Cannot send mail: #{ex.message}\n#{ex.backtrace}"
            ...
            V2::EmailReceipt.create cust.identifier, message_identifier, internal_emsg
            ...
            V2::EmailReceipt.create cust.identifier, message_identifier, internal_emsg.to_json
            raise OT::Problem, errmsg
          end
          ...
          V2::EmailReceipt.create cust.identifier, message_identifier, mailer_response.to_json

          OT.info "[email-sent] to #{email_address_obscured} #{cust.identifier} #{message_identifier}"
          mailer_response
        end
