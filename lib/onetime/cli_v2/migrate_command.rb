# lib/onetime/cli_v2/migrate_command.rb
#
...
module Onetime
  module CLI
    module V2
      # Migrate Command
      #
      # NOTE: This class boots the application automatically via the Command base class.
      #
      class MigrateCommand < Command
        ...
        option :run, type: :boolean, default: false, aliases: ['r'], desc: 'Actually apply changes (default is dry run mode)'
