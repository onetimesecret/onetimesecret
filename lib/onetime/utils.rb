...
module Onetime
  module Utils
    ...
    # Generates a short hexadecimal ID suitable for process identification
    # @param length [Integer] Length of the generated ID (default: 8)
    # @return [String] A hexadecimal string ID
