  ...
  class Plan
    class << self
      ...
      def load_plans!
        ...
        # Hacker News special
        add_plan :personal_hn, 0, 0, :ttl => 14.days, :size => 50_000, :api => true, :name => 'HN Special'
        # Reddit special
        add_plan :personal_reddit, 0, 0, :ttl => 14.days, :size => 25_000, :api => true, :name => 'Reddit Special'
        # Added 2011-12-24s
        add_plan :basic_v1, 10.0, 0.5, :ttl => 30.days, :size => 25_000, :api => true, :name => 'Basic'
        add_plan :individual_v1, 0, 0, :ttl => 14.days, :size => 25_000, :api => true, :name => 'Individual'
        # Added 2012-01-27
        add_plan :nonprofit_v1, 0, 0, :ttl => 30.days, :size => 25_000, :api => true, :cname => true, :name => 'Non Profit'
      end
    end
