  ...
  class Plan
    class << self
      ...
      def load_plans!
        ...
        add_plan :professional_v1, 30.0, 0.50, :ttl => 30.days, :size => 1_000_000, :api => true, :cname => true, :name => 'Professional'
        add_plan :professional_v2, 30.0, 0.333333, :ttl => 30.days, :size => 1_000_000, :api => true, :cname => true, :name => 'Professional'
        add_plan :agency_v1, 100.0, 0.25, :ttl => 30.days, :size => 1_000_000, :api => true, :private => true, :name => 'Agency'
        ...
        # Added 2012-01-27
        add_plan :nonprofit_v1, 0, 0, :ttl => 30.days, :size => 1_000_000, :api => true, :cname => true, :name => 'Non Profit'
      end
    end
