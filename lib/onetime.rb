...
module Onetime
  ...
  class Plan
    ...
    add_plan :professional_v1, 30.0, 0.50, :ttl => 90.days, :size => 5_000, :api => true, :name => 'Professional'
    add_plan :professional_v2, 30.0, 0.333333, :ttl => 90.days, :size => 5_000, :api => true, :name => 'Professional'
    add_plan :agency_v1, 100.0, 0.25, :ttl => 90.days, :size => 10_000, :api => true, :name => 'Agency'
    add_plan :agency_v2, 75.0, 0.33333333, :ttl => 90.days, :size => 10_000, :api => true, :name => 'Agency'
  end
