  ...
  namespace :visual do
    ...
    task :seed do
      ...
      seed_domain = ->(host, brand) do
        ...
        validator                                   = Onetime::CustomDomain::BrandSettings
        validator.validate!(brand) if validator.respond_to?(:validate!)
      ...
      seed_cells = ->(dom_host) do
        ...
        receipt.source           = 'incoming' if receipt.respond_to?(:source=)
        receipt.save
