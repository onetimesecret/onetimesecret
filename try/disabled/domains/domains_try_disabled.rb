...
@input_domains.map { |input_domain|
  begin
    Onetime::CustomDomain.base_domain(input_domain)
...
@input_domains.map { |input_domain|
  begin
    Onetime::CustomDomain.display_domain(input_domain)
...
obj = Onetime::CustomDomain.new('tryouts.onetimesecret.com', '12345@example.com')
...
obj = Onetime::CustomDomain.new('a.tryouts.onetimesecret.com', '12345@example.com')
@unique_identifier_collector << obj.identifier
obj.identifier
...
obj = Onetime::CustomDomain.new('b.tryouts.onetimesecret.com', '12345@example.com')
@unique_identifier_collector << obj.identifier
obj.identifier
...
## (i.e. not the same as a.tryouts.onetimesecret.com).
obj = Onetime::CustomDomain.new('onetimesecret.com', '12345@example.com')
@unique_identifier_collector << obj.identifier
obj.identifier
...
obj = Onetime::CustomDomain.new('tryouts.onetimesecret.com', '67890@example.com')
@unique_identifier_collector << obj.identifier
obj.identifier
#=> "e9b334e43f13c0104ee3"

## A subdomain of a custom domain will have its own unique identifier
obj = Onetime::CustomDomain.new('a.tryouts.onetimesecret.com', '67890@example.com')
@unique_identifier_collector << obj.identifier
obj.identifier
...
## Another subdomain of a custom domain will have a different unique identifier
## (i.e. not the same as a.tryouts.onetimesecret.com).
obj = Onetime::CustomDomain.new('b.tryouts.onetimesecret.com', '67890@example.com')
@unique_identifier_collector << obj.identifier
obj.identifier
...
## An apex domain will have its unique identifier too
## (i.e. not the same as a.tryouts.onetimesecret.com).
obj = Onetime::CustomDomain.new('onetimesecret.com', '67890@example.com')
@unique_identifier_collector << obj.identifier
obj.identifier
...
custom_domain = Onetime::CustomDomain.new(@valid_domain, "user@example.com")
...
begin
  Onetime::CustomDomain.create('tryouts.onetimesecret.com')
...
begin
  obj = Onetime::CustomDomain.parse('tryouts.onetimesecret.com', nil)
  obj.identifier
rescue OT::Problem => e
  e.message
end
...
obj = Onetime::CustomDomain.new('www.onetimesecret.com', '12345@example.com')
obj.generate_txt_validation_record
obj.txt_validation_host
...
Onetime::CustomDomain.valid?('tryouts,onetimesecret.com')
#=> true

## Domain with utf8 characters is valid
Onetime::CustomDomain.valid?('tést.com')
#=> true

## Domain with an emoji is valid
Onetime::CustomDomain.valid?('😀.com')
#=> true

## Domain with a kanji character is valid
Onetime::CustomDomain.valid?('テスト.com')
#=> true

## Domain with pinyin characters is valid
Onetime::CustomDomain.valid?('测试.com')
#=> true
