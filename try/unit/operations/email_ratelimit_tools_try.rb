...
#=> ["feedback", "passphrase", "invite", "login", "email_auth_ip", "reset_request_ip", "reset_request_email", "create_account_ip", "colonel_elevation", "colonel_mutation", "colonel_destructive", "colonel_handle_resolve", "dns", "create_secret"]
