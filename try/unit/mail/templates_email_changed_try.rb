...
#
# EmailChanged is a security notification sent to OLD email when email address is changed.
# Required data: old_email, new_email_masked
...
## EmailChanged validates presence of new_email_masked
begin
  Onetime::Mail::Templates::EmailChanged.new({
    old_email: 'olduser@example.com'
  })
...
## EmailChanged new_email_masked returns masked email
template = Onetime::Mail::Templates::EmailChanged.new(@valid_data)
template.new_email_masked
#=> 'n***@example.com'
