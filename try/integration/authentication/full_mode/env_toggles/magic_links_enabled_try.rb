# try/integration/authentication/advanced_mode/env_toggles/magic_links_enabled_try.rb
#
...
#
# REQUIRES: Advanced mode with AUTHENTICATION_MODE=advanced and ENABLE_MAGIC_LINKS=true
