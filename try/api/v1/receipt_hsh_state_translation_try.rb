...
## TC-15: Sequential lifecycle new→revealed never leaks v0.24 states
## (#3633 retired the previewed! intermediate transition)
...
# Step 2: after revealed! transition
...
## TC-16: Sequential lifecycle new→burned never leaks v0.24 states
## (#3633 retired the previewed! intermediate transition)
v024_only = %w[previewed revealed shared]
